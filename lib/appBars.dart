...
Widget emptyAppbar(BuildContext context, String name, String designation, String firstLetter, String lastname) {
  return PreferredSize(
      ...
      actions: <Widget>[
       GestureDetector (
        ...
        //   Navigator.push(context,
             //  MaterialPageRoute(builder: (context) => MyHomePage(name, designation)));
         },
        ),
      ],
      elevation: 0,
